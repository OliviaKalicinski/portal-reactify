...
const PRODUTOS: Produto[] = [
  {
    ...
    corCard: "#FF6600",
    fotos: [
      "/assets/images/produtos/original-frente.jpg",
      "/assets/images/produtos/original-produto.jpg",
      "/assets/images/produtos/original-dosagem.jpg",
      "/assets/images/produtos/original-pet.jpg",
    ],
  ...
  },
  {
    ...
    corCard: "#33FF99",
    fotos: [
      "/assets/images/produtos/spirulina-frente.jpg",
      "/assets/images/produtos/spirulina-produto.jpg",
      "/assets/images/produtos/spirulina-dosagem.jpg",
    ],
  ...
  },
  {
    ...
    corCard: "#FFCC00",
    fotos: [
      "/assets/images/produtos/suplemento-integral-frente.jpg",
      "/assets/images/produtos/suplemento-integral-produto.jpg",
      "/assets/images/produtos/suplemento-integral-dosagem.jpg",
    ],
  ...
  },
  {
    ...
    corCard: "#FF0066",
    fotos: [
      "/assets/images/produtos/suplemento-concentrado-frente.jpg",
      "/assets/images/produtos/suplemento-concentrado-produto.jpg",
      "/assets/images/produtos/suplemento-concentrado-dosagem.jpg",
    ],
  ...
  },
  {
    ...
    corCard: "#FCBA97",
    fotos: [
      "/assets/images/produtos/suplemento-felino-frente.jpg",
      "/assets/images/produtos/suplemento-felino-produto.jpg",
      "/assets/images/produtos/suplemento-felino-dosagem.jpg",
    ],
  ...
  },
  {
    ...
    corCard: "#3FFF33",
    fotos: [
      "/assets/images/produtos/grub-frente.jpg",
      "/assets/images/produtos/grub-produto.jpg",
      "/assets/images/produtos/grub-info.jpg",
    ],
