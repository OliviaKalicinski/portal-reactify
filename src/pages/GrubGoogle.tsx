...
/* ──────────────────────────────────────────────────────────────
   LP CAMPANHA — GRUB · REPTEIS & ANFIBIOS · /g/grub  [GEMEA DO GOOGLE]
   Clone de /grub (Grub.tsx) para o Google Ads. Difere em 3 coisas e so nelas:
   noindex, utm_source proprio e o cupom GOOGLE10 embutido na URL.
   SEM FRETE GRATIS — decisao da Olivia 02/09/26, igual a irma.
...
const UTM_FALLBACK = {
  utm_source: "lp-grub-google",
  utm_medium: "lp",
  utm_campaign: "lp-grub-google",
};
...
const GrubGoogle = () => {
  ...
  return (
    <div className="grub-lp">
      {/* noindex: gemea quase identica a /grub — as duas competiriam pela mesma
          busca organica. Esta existe so pra separar o trafego do Google Ads
          (utm_source proprio + GOOGLE10 embutido). O AdsBot rastreia a landing
          page independente do noindex. */}
      <PageMeta
        noindex
      ...
      <div className="grb-sticky-cta">
        <div className="grb-sticky-info">
          ...
          <span className="grb-sticky-price">R$ {PRICE_OFF} · 4× sem juros</span>
        </div>
